...
<div class="stickymain">
    <div class="sticky">
        ...
        <div class="admin">
            <a href="Maquette_page_chambre.php" class="button">
                CLIENT </a>
        </div>
    </div>
</div>
    ...
    <div class="vente">
        <div id="menu">
            ...
            <div class="modifier">
                <a href="Maquette_page_chambre_modifier.php" class="button">MODIFIER</a>
            </div>
        </div>
    </div>
...
<div>
    <input type="checkbox" id="scales" name="scales">
    <label for="scales">option 2</label>
</div>
<div>
    <input type="checkbox" id="scales" name="scales">
    <label for="scales">option 3</label>
</div>

<div>
    <input type="checkbox" id="scales" name="scales">
    <label for="scales">option 4</label>
</div>
<div>
    <input type="checkbox" id="scales" name="scales">
    <label for="scales">option 5</label>
</div>
<div>
    <input type="checkbox" id="scales" name="scales">
    <label for="scales">option 6</label>
</div>
</div>
    <footer>
        <h1> FOOTER </h1>
